...
object TexasHoldem_Command: CommandExecutor {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean{
        ...
        when(args[0]){
            ...
            "help"->{
                sender.sendMessage("/poker start <チップ一枚あたりの金額:10000円以上> <最低募集人数:2〜4人> (最大募集人数:2〜4人) (周回数：１〜４):テキサスホールデムの参加者を募集します 参加人数分だけゲームが行われます §4注意 設定金額×"+ Main.con.getInt("firstNumberOfChips")+"が必要です")
